	...
	<table class="table table-striped">
		...
		<tbody>
			<?php if (count($glossaries)): foreach ($glossaries as $glossary): ?>
				<tr>
					<td><?php echo anchor('admin/glossary/edit/' . $glossary->id, $glossary->description); ?></td>
					<td><?php echo btn_edit('admin/glossary/edit/' . $glossary->id); ?></td>
					<td><?php echo btn_delete('admin/glossary/delete/' . $glossary->id); ?></td>
				</tr>
			<?php endforeach; ?>
			<?php else: ?>
				<tr>
