<section>
	...
	<?php echo anchor($this->data['langName'] . '/admin/qualification/edit', 
				'<span class="glyphicon glyphicon-plus"></span> Add a qualification'); ?>
	<table class="table table-striped">
		...
		<tbody>
			<?php if (count($qualifications)): foreach ($qualifications as $qualification): ?>
				<tr>
					<td><?php echo anchor($this->data['langName'] . '/admin/qualification/edit/' . $qualification->id, 
							$qualification->name); ?>
					</td>
